            ...
            DifficultyLevel(
                ...
                rule_sets=[
                    ...
                    [
                        ...
                        PredictPacmanRule(prediction_steps=2, priority=1.5),
                        IntelligentWanderRule(priority=1.0),
                    ...
                    [
                        ...
                        PredictPacmanRule(prediction_steps=1, priority=1.0),
            ...
            DifficultyLevel(
                ...
                rule_sets=[
                    ...
                    [
                        ...
                        BlockEscapeRoute(priority=2.2),
                        PredictPacmanRule(prediction_steps=2, priority=1.8),
                        IntelligentWanderRule(priority=1.0)
                    ],
                    ...
                    [
                        ...
                        PredictPacmanRule(prediction_steps=4, priority=2.0),
                        FlankPacmanRule(priority=1.5),
                        IntelligentWanderRule(priority=1.0)
                    ],
                    # Привид 4: Універсальний підтримувач
                    [
                        EnhancedVisionRule(sight_radius=6, sound_radius=3, memory_duration=3.5, priority=3.2),
                        PredictPacmanRule(prediction_steps=3, priority=2.0),
                        FlankPacmanRule(priority=1.8),
                        BlockEscapeRoute(priority=1.5),
